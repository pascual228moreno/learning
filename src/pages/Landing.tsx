  ...
  <section className="py-20 md:py-32 px-6">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <Link to="/portal" className="bg-golive text-white px-10 py-5 rounded-2xl font-bold text-xl shadow-2xl shadow-golive/30 hover:bg-golive-hover transition-all hover:-translate-y-1 active:translate-y-0">
